...
class ManuscriptPanel(QFrame):
    ...
    def __init__(self, data: WorkspaceDemoData, parent: QWidget | None = None) -> None:
        ...
        generate_button = QPushButton("生成正文", self)
        generate_button.setAccessibleName("使用当前 Brief 生成正文")
        generate_button.setProperty("buttonRole", "primary")
        generate_button.clicked.connect(self.generation_requested)
