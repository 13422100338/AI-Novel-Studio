...
- Latest integrated business commit: `6b40765` (C12 fail-closed View Assertion review-list refresh feedback, including prior A1-A4, B1-B8, C1-C11, M1, E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, and E1b-CE1 increments).
- Planning sources:
...
- Active implementations authorized by the user: B9 (validation-before-write for model audit findings).
...
Current dispatch override: `manifest-eligibility-v2` is running E1b-SM1 with `gpt-5.6-sol` / `high`; `generation-profile-audit-policy` is running B9 with `gpt-5.6-sol` / `high`; `view-operations-ui` is paused after C12.

E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, E1b-CE1, C6a, C6b, C7, C8, C9, C10, C11, C12, B4, B5, B6, B7, and B8 are integrated. Every later increment still requires a new user decision.
