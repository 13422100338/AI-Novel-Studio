...
- Latest integrated business commit: `9e74afe` (B8 live model-audit completion snapshot guard, including prior A1-A4, B1-B7, C1-C11, M1, E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, and E1b-CE1 increments).
- Planning sources:
...
Current dispatch override: `manifest-eligibility-v2` is paused after E1b-CE1; `generation-profile-audit-policy` is paused after B8; `view-operations-ui` is paused after C11.

E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, E1b-CE1, C6a, C6b, C7, C8, C9, C10, C11, B4, B5, B6, B7, and B8 are integrated. Every later increment still requires a new user decision.
