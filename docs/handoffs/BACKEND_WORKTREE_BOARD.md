...
- Latest integrated business commit: `f91a66a` (B5 exact model-audit evidence-anchor validation, including prior A1-A4, B1-B4, C1-C6b, M1, E1a, and E1b-SR1 increments).
- Planning sources:
...
- Active implementations authorized by the user: E1b-SS1 Style Sample review-state omissions.
...
E1a, E1b-SR1, C6a, C6b, B4, and B5 are integrated. E1b-SS1 remains active under its separately approved scope; every later increment still requires a new user decision.
