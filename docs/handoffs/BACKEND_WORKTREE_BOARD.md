...
- Active implementations authorized by the user: none. C15 is integrated; the next increment
...
Current dispatch override: none. A is paused after R2b-C, B is paused after B14, and C is paused
after C15. R2c-L/R3/O1 and every other later increment remain separately authorized work.
