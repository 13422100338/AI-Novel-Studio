...
- Latest integrated business commit: `4bba49a` (R1a Formal Manuscript v19 storage and embedding identity foundation, including prior S1, P0-1, A1-A4, B1-B14, C1-C14, M1, E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, E1b-CE1, E1b-SM1, SE1-SE3, and ST1 increments).
- Planning sources:
...
- Active implementations authorized by the user: R1b deterministic Formal Manuscript chunk
  projection and bounded manual build on A.
...
| `manifest-eligibility-v2` | `gpt-5.6-sol` / `high` | `019f87e8-6d32-7141-b9b4-4f1142e4db4e` | `C:\Users\钟子诚\.codex\worktrees\93d7\AI-Novel-Studio` | `codex/manifest-eligibility-r1b` | branch | R1b authorized from latest main; no schema ownership; implementation pending |
...
Current dispatch override: A owns only R1b under ADR 0022's frozen
`paragraph-codepoint-v1` contract. B is paused after its Gate S0 report;
`view-operations-ui` is paused after S1; `style-engine` remains paused after ST1,
...
embedding-cache contract. R1a/schema v19 is integrated; R1b is authorized as a no-schema,
manual-build-only increment; R2-R4, O1-O2, H1, and V1 remain unauthorized.
...
E1a, E1b-SR1, E1b-SS1, E1b-CR1, E1b-CS1, E1b-CE1, E1b-SM1, SE1, SE2a, SE2c-W1, SE3, ST1, S1, R1a, C6a, C6b, C7, C8, C9, C10, C11, C12, C13, C14, B4, B5, B6, B7, B8, B9, B10, B11, B12, B13, B14, and P0-1 are integrated. Every later increment still requires a new user decision.
